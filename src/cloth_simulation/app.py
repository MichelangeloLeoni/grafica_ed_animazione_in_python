'''
Core application script containing the ClothApp class which manages the Tkinter GUI lifecycle,
user entries, and orchestrates the rendering and physics steps.
'''
import time
...
class ClothApp:
    ...
    def __init__(self, root):
        ...
        # NumPy Data-Oriented mesh container
        self.mesh = None
